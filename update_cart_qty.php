...
$res3=mysqli_query($conn,"select * from cart_detail where shoes_id='$sid' and cart_id='$cartid'");
...
if(isset($_POST['btnupdate']))
{
	...
	$query="update cart_detail set size='$size1',qty='$qty' where cart_d_id='$cdid'";
	if(mysqli_query($conn,$query))
	{	
		echo "<script type='text/javascript'>";
		echo "alert('Shoes Quantity Updated Succesfully');";
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<div class="product_count">
							...
							<input type="text" name="txtqty" id="sst" maxlength="12" value="<?php echo $qty1; ?>" title="Quantity:" class="input-text qty" >
						...
						<div class="product_count" >
							...
							{
								?>
								<option <?php if($q5[2]==$size2){ echo "selected='selected'"; }?>><?php echo $q5[2]; ?></option>
								<?php
							}
							?>
							</select>
						...
						<div class="card_area d-flex align-items-center">
							<input type="submit" value="UPDATE CART" class="primary-btn" name="btnupdate">
